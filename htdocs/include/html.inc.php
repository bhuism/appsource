...
function html_form_option_values($name,$arr,$tdefault='',$onchangesubmit = false)
{
$temp = Array();
foreach($arr as $item) $temp[$item] = $item;
return html_form_option($name,$temp,$tdefault,$onchangesubmit);
};
...
function html_form_submitimg($src = '/images/text.php4?Verstuur',$name = 'submitbuttonvalue')
{
